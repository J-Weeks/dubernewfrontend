...
/***/ function(module, exports, __webpack_require__) {
	...
	var userSignOut = function userSignOut(userinfo) {
	  $.ajax({
	...
	var getDogs = function getDogs(userData) {
	  $.ajax({
	...
	var displayDogs = function displayDogs(dogs) {
	  // debugger;
	  var dogsTemplate = __webpack_require__(4); // debugger;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div class=\"jumbotron\">\n    <div class='container'>\n      <div class='dog-description'>\n        <div class='dog-thumb'><img style='max-height: 250px; max-width: 250px' src=\""
	    ...
	    + "\n          </div>\n        </div>\n        <div class='dog-actions'>\n          <button type=\"button\" class=\"btn btn-primary\">Edit Dog</button>\n          <button type=\"button\" class=\"btn btn-danger\">Remove Dog</button>\n\n        </div>\n      </div>\n    </div>\n  </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.dogs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
